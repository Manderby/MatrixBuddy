...
NA_LOC(MATHelpMMulCompV,      "Multipliziert die Spalten einer Matrix mit den Komponenten eines Vektors.");
NA_LOC(MATHelpMDivCompV,      "Dividiert die Spalten einer Matrix durch die Komponenten eines Vektors.");
...
NA_LOC(MATErrorVectorLengthAlmostZero,      "Beinahe 0");
NA_LOC(MATErrorVectorsCollinear,            "Kolinear");
